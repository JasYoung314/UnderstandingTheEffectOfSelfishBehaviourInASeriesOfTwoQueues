...
for e in Data:
    ...
    for i in e:
        pdata.append([i[_sage_const_1 ],(i[-_sage_const_3 ]/i[-_sage_const_1 ])])
        qdata.append([i[_sage_const_1 ],(i[-_sage_const_3 ]/i[-_sage_const_2 ])])
    ...
    if not int(_sage_const_24 *e[_sage_const_0 ][_sage_const_7 ])+_sage_const_1  == _sage_const_4  and not int(_sage_const_24 *e[_sage_const_0 ][_sage_const_7 ])+_sage_const_1  == _sage_const_16 :
        p+= line(pdata,color = 'black',linestyle = styles[Data.index(e)],legend_label = '%s days %s hours' %(e[_sage_const_0 ][_sage_const_6 ],min(int(_sage_const_24 *e[_sage_const_0 ][_sage_const_7 ])+_sage_const_1 ,_sage_const_24 )))
        q+= line(qdata,color = 'black',linestyle = styles[Data.index(e)],legend_label = '%s days %s hours' %(e[_sage_const_0 ][_sage_const_6 ],min(int(_sage_const_24 *e[_sage_const_0 ][_sage_const_7 ])+_sage_const_1 ,_sage_const_24 )))
